...
class LocalController {
    ...
    addAll() {
        const buildFolder = zos_lib_1.Contracts.getLocalBuildDir();
        const sourceFolder = zos_lib_1.Contracts.getLocalContractsDir();
        zos_lib_1.FileSystem.readDir(buildFolder).forEach((file) => {
